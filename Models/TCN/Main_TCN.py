...
metrics_df.to_csv('/home/j/usfq/tesis/StockPredictionModels/Results/tcn_metrics.csv',index=False)
std_metrics_df.to_csv('/home/j/usfq/tesis/StockPredictionModels/Results/tcn_std_metrics.csv',index=False)
metrics=[]
df_dict={}
...
# %%
    ...
    tuner = kt.GridSearch(build_model,
                        objective='val_loss',
                        directory='/home/j/usfq/tesis/StockPredictionModels/Models/TCN/Tuning',
    ...
    # %%
    dir='/home/j/usfq/tesis/StockPredictionModels/Graphs/TCN/'+ticker
...
df_ps.to_csv('/home/j/usfq/tesis/StockPredictionModels/Results/tcn_hypothesis.csv',index=False)
...
df_loss.to_csv('/home/j/usfq/tesis/StockPredictionModels/Results/tcn_loss.csv',index=False)
