...
metrics_df.to_csv('/home/j/usfq/tesis/StockPredictionModels/Results/bilstm_metrics.csv',index=False)
std_metrics_df.to_csv('/home/j/usfq/tesis/StockPredictionModels/Results/bilstm_std_metrics.csv',index=False)
metrics=[]
df_dict={}
...
# %%
    ...
    # %%
    dir='/home/j/usfq/tesis/StockPredictionModels/Graphs/biLSTM/'+ticker
...
df_ps.to_csv('/home/j/usfq/tesis/StockPredictionModels/Results/bilstm_hypothesis.csv',index=False)
...
df_loss.to_csv('/home/j/usfq/tesis/StockPredictionModels/Results/bilstm_loss.csv',index=False)
