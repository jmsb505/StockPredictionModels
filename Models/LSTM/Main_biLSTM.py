...
# %%
    ...
    def build_model(hp):
        ...
        model=Sequential()
        model.add(Bidirectional(LSTM(hp_units,input_shape=(X.shape[1],X.shape[2]),return_sequences=False)))
    ...
    for train_index, test_index in tscv.split(X):
        ...
        plt.close()
        if counter_fold==11:
            model.save_weights(f'/home/j/usfq/Proyecto-Integrador/StockPredictionModels/Models/LSTM/Weights/model_{arch}_{ticker}.h5')
        print(f'{Fold} Done')
